...
export class WildAnimalSpeciesControllerService extends BaseService {
  constructor(
  ...
  /**
   * Path part for operation wildAnimalSpeciesControllerGetSpecies
   */
  static readonly WildAnimalSpeciesControllerGetSpeciesPath = '/wild-animals/{id}/species';
  ...
  getSpecies$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, WildAnimalSpeciesControllerService.WildAnimalSpeciesControllerGetSpeciesPath, 'get');
    if (params) {
