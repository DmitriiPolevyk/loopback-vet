...
export class AnimalSpeciesControllerService extends BaseService {
  constructor(
  ...
  /**
   * Path part for operation animalSpeciesControllerGetSpecies
   */
  static readonly AnimalSpeciesControllerGetSpeciesPath = '/animals/{id}/species';
  ...
  getSpecies$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, AnimalSpeciesControllerService.AnimalSpeciesControllerGetSpeciesPath, 'get');
    if (params) {
